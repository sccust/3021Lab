...
public class TestFinal {
	public static void main(String[] args) {
		...
		System.out.println(tree.getLeftChild().getRightChild().getRightChild()
				.getData()
				+ "");
		...
		doubTree.getRightChild().getRightChild()
				.setRightChild(new GeneralTreeNode<Double>(0.99));
		...
		/** Q2(1) */
		if (doubTree.getRightChild().getRightChild().getRightChild().getData()
				.equals(0.99)
				&& stuTree.getLeftChild().getRightChild().getData()
						.equals(new Student("Kim", "f"))
				&& teacTree.getRightChild().getLeftChild().getRightChild()
						.getData().equals(new Teacher("Wang", 2222))) {
			totalScore += 2;
			scoreDetail += "2 ";
		} else
			scoreDetail += "0 ";
		...
		System.out.println(doubSymmetric);
		System.out.println(strSymmetric);
		System.out.println(stuSymmetric);
		System.out.println(teacSymmetric);
		if (!doubSymmetric && !strSymmetric && stuSymmetric && !teacSymmetric) {
			totalScore += 2;
			scoreDetail += "2 ";
		} else
			scoreDetail += "0 ";
